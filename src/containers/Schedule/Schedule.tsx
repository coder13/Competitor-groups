...
const ScheduleDay = ({
  ...
  return (
    <div className="flex flex-col">
      <div
        className="w-full text-center bg-slate-50 dark:bg-gray-800 hover:bg-slate-100 dark:hover:bg-gray-700 text-gray-900 dark:text-white font-bold text-lg mb-1 select-none cursor-pointer h-10 transition-colors duration-150"
