...
export const eventNameById = (eventId: string) => propertyById('name', eventId);

export const shortEventNameById = (eventId: string) => propertyById('shortName', eventId);

const propertyById = (property: 'id' | 'name' | 'shortName', eventId: string) =>
